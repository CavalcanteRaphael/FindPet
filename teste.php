    ...
    <?php 
      ...
      $stmt = $conn->query("SELECT animal.idanimal, animal.idusuario, animal.cor, animal.img, animal.porte, animal.especie, animal.raca, animal.sexo, animal.descricao, animal.tipo, animal.nome, usuario.email FROM animal INNER JOIN usuario ON animal.idusuario = usuario.idusuario;");
